...
export default function LoginForm() {
  ...
  const submitLogin = async () => {
    ...
    await axios.post(`${URL}/employees/authenticate/details`, formData)
      .then((res) => {
        if (res.data.success) {
        ...
        <div className="u-clearfix u-sheet u-valign-middle-sm u-valign-middle-xs u-sheet-1">
          <div className="u-align-center u-border-14 u-border-no-left u-border-no-right u-border-no-top u-border-palette-4-light-1 u-container-style u-custom-border u-group u-opacity u-opacity-55 u-palette-1-base u-shape-rectangle u-group-1">
            <div className="u-container-layout u-container-layout-1">
              <span className="u-file-icon u-icon u-icon-circle u-palette-4-light-1 u-spacing-25 u-icon-1">
                <img src={_10} alt="" />
              </span>
              <h1 className="u-hover-feature u-text u-text-default u-text-palette-4-dark-1 u-text-1 d-flex justify-contents-center align-items-center">
                <span style={{ fontStyle: "italic", margin: "auto" }}>
                  LOGIN
                </span>
              ...
              <div className="u-form u-login-control u-form-1">
                <form
                  ...
                  className="u-clearfix u-form-custom-backend u-form-spacing-50 u-form-vertical u-inner-form"
                  source="custom"
                  name="form"
                  style={{ padding: "19px" }}
                >
                  <div className="u-form-group u-form-name u-label-top">
                    <label
                      htmlFor="username-a30d"
                      className="u-label u-text-palette-4-light-1 u-label-1"
                    >
                      Email Address
                    </label>
                    <input
                  ...
                  <div className="u-form-group u-form-password u-label-top u-form-group-2">
                    <label
                      htmlFor="password-a30d"
                      className="u-label u-text-palette-4-light-1 u-label-2"
                    >
                      Password
                    </label>
                    <input
                  ...
                  <div className="u-align-left u-form-group u-form-submit u-label-top">
                    ...
                    <button
                      type="submit"
                      className="u-active-palette-4-dark-2 u-border-none u-btn u-btn-submit u-button-style u-hover-palette-4-light-1 u-palette-4-dark-1 u-btn-1"
                    >
                      Login
                    </button>
                  </div>
